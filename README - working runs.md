...
python -m scdc_lab.experiments.unified_consistency_universe \
 \
  ...
  --rule threshold --threshold 2 --steps 120 \
  --seed 1 --out_prefix runs/pf0.12_seed1
```
...
```bash
python -m scdc_lab.experiments.h1_radiation_search --n 500 --layers 100   --p_forward 0.05 --p_skip 0.02   --knot_k 20   --rule xor --steps 200   --excite ones --seed 3 --out_csv h1_rad_knot_impulse.csv
```

Negative control (no knot):

```bash
python -m scdc_lab.experiments.h1_radiation_search --n 500 --layers 100   --p_forward 0.05 --p_skip 0.02   --knot_k 0   --rule xor --steps 200   --excite ones --seed 3 --out_csv h1_rad_noknot_impulse.csv
```
