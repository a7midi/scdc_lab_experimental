...
COMMON_ARGS="--graph_type layered --n 500 --layers 100   --p_skip2 0.02 --p_skip3 0.005   --energy_mode motif --genesis_steps 1500   --rule threshold --threshold 2 --steps 120   --inject_knot_k 20 --knot_p 0.9"
